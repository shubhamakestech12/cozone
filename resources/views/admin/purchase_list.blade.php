        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Amenties</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form id="frm_amenties">
                                        <input type="hidden" name="_token" value="">       
                                               <input type="hidden" name="id" id="id">
                                        <div class="form-row mx-n15">
                                            <div class="col-md-12 mb-20 px-15">
                                                <label for="validationDefault01" class="il-gray fs-14 fw-500 align-center">Amenties</label>
                                                <input type="text" class="form-control ih-medium ip-light radius-xs b-light" placeholder="Enter Name" name="amenties" id="amenties">
                                            </div>
                                            ...
                                            <div class="form-row mb-20 ">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-20 px-15">
                                                    ...
                                                    <input type="file" accept="image/png, image/jpeg,image/svg,image/jpg" class="form-control  ih-medium ip-light radius-xs b-light" name="image" id="image" style="opacity: 0;position: absolute;" onchange="showSelectedImage(this)">
                                                </div> 
                                                <div class="col-lg-2 mx-3" id="addcode_amenty" style="border:1px solid #e3e6ef;">
                    ...
                    <div class="card-body pt-0 pb-0">
                        <div class="drag-drop-wrap">
                            <div class="table-responsive table-revenue w-100 mb-30">
                                <table class="table mb-0 table-basic" id="amenty_datatable" width="100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
