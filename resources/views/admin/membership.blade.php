        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">MemberShip Plans</h4>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <form id="frm_plan">
                                        ...
                                        <div class="form-row mx-n15">
                                            ...
                                            <div class="col-md-12 mb-20 px-15">
                                                <label for="validationDefault01" class="il-gray fs-14 fw-500 align-center">Select Plan Duration</label>
                                            ...
                                            <div class="form-row mx-n15">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-20 px-15">
                                                    <label for="image" class="il-gray fs-14 fw-500 align-center">Upload Icon</label>
                                                    ...
                                                    <input type="file" class="form-control  ih-medium ip-light radius-xs b-light" name="image" id="image" style="opacity: 0;position: absolute;">
                                                </div> 
                    ...
                    <div class="card-body pt-0 pb-0">
                        <div class="drag-drop-wrap">
                            <div class="table-responsive table-revenue w-100 mb-30">
                                <table class="table mb-0 table-basic" id="plan_datatable" width="100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Plan Name</th>
